...
The current glassmorphism button components (Button) present UX and accessibility challenges:
...
- **BREAKING**: Replace all Button components with standard shadcn Button components
...
### Migration Path
- All Button imports → Button imports
- Variant mapping: `Button variant="secondary"` → `Button variant="outline"`
