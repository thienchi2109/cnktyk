...
import type { ComponentPropsWithoutRef, ComponentPropsWithRef, ElementRef, ReactElement } from 'react';
...
const twStyles = {
  ...
  close: [
    ...
    'hover:text-neutral-950 focus:outline-none focus:ring-2',
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport ref={ref} className={cn(twStyles.viewport, className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action ref={ref} className={cn(twStyles.action, className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} className={cn(twStyles.title, className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description ref={ref} className={cn(twStyles.description, className)} {...props} />
));
