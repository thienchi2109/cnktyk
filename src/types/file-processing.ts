...
// null = wildcard/skip byte for variable-length fields (e.g., file size)
export const FILE_SIGNATURES: Record<string, (number | null)[]> = {
  ...
  // We use null as placeholder for size bytes that we skip
  'image/webp': [
    0x52, 0x49, 0x46, 0x46, // 'RIFF' header
    null, null, null, null, // File size (skip - can be any value)
